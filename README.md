...
<!--
**DziriM/DziriM** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
...
I also create **modern full-stack applications** using **.NET + Angular**, like the e-commerce platform [Skinet](https://skinet-course-auapcvdmdubqhkdx.francecentral-01.azurewebsites.net/) hosted on Azure.

🎯 **Actively looking for missions, clients, or collaborations** — whether it’s a smart bot, a solid backend, or a web app with a clean UI.
...
**🧱 Backend**  
`.NET Core, ASP.NET, Blazor Server, REST APIs, CQRS, DDD, Clean Architecture, EF Core, SQL Server, Redis`

**🎨 Frontend**  
`Angular v18, RxJS, Angular Material, TailwindCSS`

**🧪 Quality & Testing**  
`xUnit, TDD, Moq, FluentAssertions, Integration Tests, Application Insights`

**☁️ DevOps & Cloud**  
`Docker, GitHub Actions, Azure Functions, App Services, API Management`

**🧠 AI (specific project)**  
`FastAPI, TensorFlow/Keras, Streamlit – used for an image classifier`

---

## 🔥 Highlight Projects

🔹 [**Zibao**](https://github.com/DziriM) — My custom .NET scraping engine: fast, modular, anti-bot ready.  
🔹 [**Skinet**](https://github.com/DziriM/skinet) — Full-featured ski gear e-commerce app (Angular + .NET 9)  
...
- 📘 **AZ-204**: Microsoft Azure Developer Associate (2025)  
- 📘 **AZ-900**: Microsoft Azure Fundamentals (2024)  
- 🔐 NielsenIQ Security Awareness Certificate (2023)
...
🔎 Open to freelance missions and full-time contracts

---

_"Code is not just syntax. It's architecture, intention, and empathy."_
